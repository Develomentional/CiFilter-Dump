//
//  Dv_FilterCategoriesViewController.m
//  CIImageFilters
//
...
@interface Dv_FilterCategoriesViewController ()

@end

@implementation Dv_FilterCategoriesViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@",[self.filterCategories objectAtIndex:indexPath.row]];
    return cell;
}
